...
export class PhoneNumbersCreateComponent implements OnInit {
  topicName ="";
  topicDetails = "";
  imageName="";
  ...
  addTopic(){
    ...
    debugger;
    this._http.createTopic({controllerName:this.route.snapshot.params['id'],topicName:this.topicName,topicDetails:this.topicDetails,imageUrl: this.imageName}).subscribe(
      data=>{
        debugger;
      },
      error=>{
