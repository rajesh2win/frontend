...
export class TopicNewsCreateComponent implements OnInit {
  topicName ="";
  topicDetails = "";
  createdDate="";
  imgName="";
  ...
  addTopic(){
    ...
    debugger;
    this._http.createTopic({controllerName:this.route.snapshot.params['id'],topicName:this.topicName,topicDetails:this.topicDetails,imageUrl: this.imgName,createdDate:this.createdDate}).subscribe(
      data=>{
        debugger;
      },
      error=>{
