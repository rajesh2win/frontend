...
export class WorkCreateComponent implements OnInit {
  ...
  addTopic() {
    if (this.fileToUpload !== null){
     ...
     debugger;
    this._http.createTopic({controllerName:"work",item:this.route.snapshot.params['id'],topicName:this.topicName,topicDetails:this.topicDetails,imageUrl: this.imgName}).subscribe(
      data=>{
        debugger;
      },
      error=>{
