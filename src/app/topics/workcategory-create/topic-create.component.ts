...
export class WorkCategoryCreateComponent implements OnInit {
  topicName ="";
  imgName="";
  topicDetails = "";
  ...
  addTopicCategory() {
    ...
    this._http.createTopic({controllerName:"workcategory",topicName:this.topicName,imageUrl: this.imgName}).subscribe(
      data=>{
        debugger;
      },
      error=>{
